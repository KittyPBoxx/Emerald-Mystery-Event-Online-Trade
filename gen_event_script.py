...
def write_to_bin_file(data, file_name="event_script.bin"):
    with open(file_name, "wb") as f:
        f.write(data)

if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python gen_event_script.py <elf_file> <section_name>")
        print("E.g python gen_event_script.py pokeemerald.elf .mystery_event_script")
        sys.exit(1)
    ...
    try:
        ...
        print(f"Binary file 'event_script.bin' created successfully with {len(section_data)} bytes.")
